...
#define STRING_CONFIG_H_AUTHOR "eyal" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ST3D Royal"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {142.5,142.5,3200,426.6}
...
#define MANUAL_Y_HOME_POS -9 // Because the homing location interferes with the fan vent.
